...
// node_modules/@react-three/fiber/dist/index-faa0fc56.esm.js
...
function diffProps(instance, {
  ...
  entries.forEach(([key, value]) => {
    ...
    if (is.equ(value, previous[key]))
      return;
    if (/^on(LostPointer|Pointer|Click|DoubleClick|ContextMenu|Wheel)/.test(key))
    ...
    return function handleEvent(event) {
      ...
      function onIntersect(data) {
        ...
        if (isPointerMove) {
          ...
          if ("pointerId" in event && internal2.capturedMap.has(event.pointerId)) {
            requestAnimationFrame(() => {
              if (internal2.capturedMap.has(event.pointerId)) {
                internal2.capturedMap.delete(event.pointerId);
                cancelPointer([]);
...
scheduler/cjs/scheduler.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5DCUAHCD.js.map
